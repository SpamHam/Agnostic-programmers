...
public class PDFFactory {
 ...
 final private static Font redFont = new Font(Font.FontFamily.TIMES_ROMAN, 6,
  ...
  //DateConvertor myDate = new DateConvertor();
  
  public PDFFactory(ArrayList <BETimePlan> allTime, ArrayList<String> colNames, String dateName){
  this.allTime = allTime;
  this.colNames = colNames;
  FILE = filePath + dateName;
...
// Will create: Report generated by: _name, _date
    odinRaport.add(new Paragraph("Rapport genereret af: " + System.getProperty("user.name") + ", " + myDate.getConvetedDate(), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        smallBold));
