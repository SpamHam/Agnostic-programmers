...
public class PDFGenerator {
 ...
 //String fileName = new DateConverter(DateConverter.DAY_MONTH_TIME).getDate();
  ...
  private void createODIN(Document document)
    ...
    odinRaport.add(new Paragraph("Rapport genereret af: " + System.getProperty("user.name") + ", " + new DateConverter(DateConverter.WEEKDAY_DAY_MONTH_YEAR_TIME).getDate(), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        smallBold));
