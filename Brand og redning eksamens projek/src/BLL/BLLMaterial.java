...
public class BLLMaterial implements MaterialListener {
    ...
    /**
     * Function that calls the Create function from DALC. If any field is empty
    ...
    /**
     * A function that calls the update function from DALC If any field is left
     * blank it will return an error
     *
     * @param event
     */
    @Override
    ...
    /**
     * A function that calls the read function from DALC
     *
     * @return DALCMaterial
     */
    @Override
