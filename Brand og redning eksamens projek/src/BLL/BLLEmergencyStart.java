...
public class BLLEmergencyStart {
    ...
    /**
     * Calls the read function from DALCEmergencyStart and populates the
     * ArrayList res
     *
     * @return res
     * @throws Exception
    ...
    /**
     * A function that removes the old dates
     *
     * @return
     * @throws SQLException
     */
    public ArrayList<String> RemoveOldDates() throws SQLException {
